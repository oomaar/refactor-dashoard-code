            ...
            <div className="page-sidebar">
                <div className="main-header-left d-none d-lg-block">
                    <div className="logo-wrapper compactLogo">
                        <Link to={`${process.env.PUBLIC_URL}/dashboard/landing`}>
                            <img className="blur-up lazyloaded" src={logo2} style={{'borderRadius':'45px','color':'red'}} width={100} alt="" />
                            <img className="blur-up lazyloaded" src={logo2}  width={200} alt="" style={{'borderRadius':'45px' , 'marginLeft':'6%'}} />
                        </Link>
                    </div>
                </div>
